...
public class PlayerInfo {
    ...
    private int team_id;
    private String active_sw; // what is this??
    ...
    private String status_code; // what is this??
    ...
    public String getPrimaryPositionText() {
    ...
    public String getDisplayNameRosterHTML() {
    ...
    public String getMatrilinealName() {
